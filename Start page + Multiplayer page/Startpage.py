...
canvas.tag_bind("start_btn", "<Button-1>", lambda e: launch_game("start.py"))    #We will add the path here
canvas.tag_bind("multi", "<Button-1>", lambda e: launch_game("Multiplayer.py"))  #We will add the path here
